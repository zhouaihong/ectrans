...
subroutine gstats_labels
  ...
  call gstats_label(478, '   ', 'LEINV          - Concurrent pair GEMM')
  ...
  call gstats_label(456, '   ', 'TRGTOL         - Pre device-update barrier')
  call gstats_label(457, '   ', 'TRGTOL         - Post device-update barrier')
  call gstats_label(458, '   ', 'TRGTOL         - Pre MPI barrier')
  call gstats_label(459, '   ', 'TRGTOL         - Post MPI barrier')
  call gstats_label(460, '   ', 'TRGTOL         - Assign recv buffer')
  call gstats_label(461, '   ', 'TRGTOL         - Update host ZCOMBUFS')
  call gstats_label(462, '   ', 'TRGTOL         - Post MPI receives')
  call gstats_label(463, '   ', 'TRGTOL         - Post MPI sends')
  call gstats_label(464, '   ', 'TRGTOL         - MPI wait')
  call gstats_label(465, '   ', 'TRGTOL         - Update device ZCOMBUFR')
  call gstats_label(480, '   ', 'TRGTOL         - Setup maps total')
  call gstats_label(481, '   ', 'TRGTOL         - Build send counts')
  call gstats_label(482, '   ', 'TRGTOL         - Build recv output map')
  ...
  call gstats_label(1601, '   ', 'TRGTOL         - Local self copy')
  ...
  call gstats_label(1814, '   ', 'TRLTOG         - Open present data regions')
  call gstats_label(1815, '   ', 'TRLTOG         - Build peer field map')
  call gstats_label(1816, '   ', 'TRLTOG         - Copyin peer field map')
  call gstats_label(1817, '   ', 'TRLTOG         - Allocate comm buffers')
  call gstats_label(1805, '   ', 'TRGTOL         - Setup/index/data region')
  call gstats_label(1820, '   ', 'TRGTOL         - Build send counts')
  call gstats_label(1821, '   ', 'TRGTOL         - Build recv index map')
  call gstats_label(1822, '   ', 'TRGTOL         - Assign PREEL/data copyin')
  call gstats_label(1823, '   ', 'TRGTOL         - Create ACC descriptors')
  call gstats_label(1824, '   ', 'TRGTOL         - Open present data regions')
  call gstats_label(1825, '   ', 'TRGTOL         - Allocate comm buffers')
