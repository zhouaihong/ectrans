...
MODULE TRLTOG_MOD
  ...
  PRIVATE
  PUBLIC :: TRLTOG, TRLTOG_HANDLE, PREPARE_TRLTOG, SET_TRLTOG_UPDATE_HOST

  LOGICAL, SAVE :: LTRLTOG_UPDATE_HOST = .TRUE.
...
CONTAINS
  SUBROUTINE SET_TRLTOG_UPDATE_HOST(LDUPDATE_HOST)
    ...
    LTRLTOG_UPDATE_HOST = LDUPDATE_HOST
...
#define TRLTOG_DTYPE MPI_REAL8
    ...
    LUPDATE_HOST = LTRLTOG_UPDATE_HOST
    IF (PRESENT(LDUPDATE_HOST)) LUPDATE_HOST = LDUPDATE_HOST
...
#endif
    CALL GSTATS(425,1)
    IF (LUPDATE_HOST .AND. PRESENT(PGP)) THEN
      CALL GSTATS(426,0)
#ifdef OMPGPU
      ...
      CALL GSTATS(426,1)
    ENDIF
    IF (LUPDATE_HOST .AND. PRESENT(PGPUV)) THEN
      CALL GSTATS(427,0)
#ifdef OMPGPU
...
SUBROUTINE SET_TRLTOG_UPDATE_HOST(LDUPDATE_HOST)
  USE TRLTOG_MOD, ONLY: SET_TRLTOG_UPDATE_HOST_MOD => SET_TRLTOG_UPDATE_HOST
  IMPLICIT NONE

  LOGICAL, INTENT(IN) :: LDUPDATE_HOST

  CALL SET_TRLTOG_UPDATE_HOST_MOD(LDUPDATE_HOST)
END SUBROUTINE SET_TRLTOG_UPDATE_HOST
