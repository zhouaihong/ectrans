...
#ifndef TRANS_SINGLE
    USE TPM_FLT,                     ONLY: S
    USE BUTTERFLY_GPU_DP_MOD,        ONLY: APPLY_BUTTERFLY_DIRECT,BUTTERFLY_DIRECT_REQUESTED
#endif
...
#define HIP_GEMM HIP_DGEMM_GROUPED
...
#ifndef TRANS_SINGLE
      IF (LUSE_BUTTERFLY_DIRECT .AND. S%PLAN_A%ENABLED .AND. &
    ...
    DO KMLOC=1,D_NUMP
      ...
      COFFSETS(KMLOC) = IOUT_STRIDES0*D_OFFSETS_GEMM2(KMLOC)
#ifndef TRANS_SINGLE
      IF (LUSE_BUTTERFLY_DIRECT .AND. S%PLAN_S%ENABLED .AND. &
