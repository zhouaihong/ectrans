  ...
  SUBROUTINE LTINV(ALLOCATOR,HLTINV,KF_UV,KF_SCALARS,&
    ...
    IF (KF_SCALARS > 0) THEN
      ...
      IF(PRESENT(PSPSCALAR)) THEN
        ...
        IF (LSCDERS) THEN
          CALL LTINV_PACK_NSDER_PAIR(ZINPA,ZINPA0,ZINPS,ZINPS0,PSPSCALAR,KF_SCALARS,&
                                   & IDER_OFFSET,ZEPSNM,IIN_STRIDES0,IIN0_STRIDES0)
        ENDIF
      ...
      ELSE
        IF(PRESENT(PSPSC2) .AND. NF_SC2 > 0) THEN
          ...
          IF (LSCDERS) THEN
            CALL LTINV_PACK_NSDER_PAIR(ZINPA,ZINPA0,ZINPS,ZINPS0,PSPSC2(:,:),NF_SC2,&
                                     & IDER_OFFSET+ISCALAR_COUNT,ZEPSNM,IIN_STRIDES0,IIN0_STRIDES0)
          ENDIF
        ...
        IF(PRESENT(PSPSC3A) .AND. NF_SC3A > 0) THEN
          DO J3=1,UBOUND(PSPSC3A,3)
            CALL LTINV_PACK_SPEC_PAIR(ZINPA,ZINPA0,ZINPS,ZINPS0,PSPSC3A(:,:,J3),NF_SC3A,&
                                    & ISCALAR_OFFSET+ISCALAR_COUNT,IIN_STRIDES0,IIN0_STRIDES0)
            IF (LSCDERS) THEN
              CALL LTINV_PACK_NSDER_PAIR(ZINPA,ZINPA0,ZINPS,ZINPS0,PSPSC3A(:,:,J3),NF_SC3A,&
                                       & IDER_OFFSET+ISCALAR_COUNT,ZEPSNM,IIN_STRIDES0,IIN0_STRIDES0)
            ENDIF
        ...
        IF(PRESENT(PSPSC3B) .AND. NF_SC3B > 0) THEN
          DO J3=1,UBOUND(PSPSC3B,3)
            CALL LTINV_PACK_SPEC_PAIR(ZINPA,ZINPA0,ZINPS,ZINPS0,PSPSC3B(:,:,J3),NF_SC3B,&
                                    & ISCALAR_OFFSET+ISCALAR_COUNT,IIN_STRIDES0,IIN0_STRIDES0)
            IF (LSCDERS) THEN
              CALL LTINV_PACK_NSDER_PAIR(ZINPA,ZINPA0,ZINPS,ZINPS0,PSPSC3B(:,:,J3),NF_SC3B,&
                                       & IDER_OFFSET+ISCALAR_COUNT,ZEPSNM,IIN_STRIDES0,IIN0_STRIDES0)
            ENDIF
