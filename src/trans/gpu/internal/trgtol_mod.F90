...
MODULE TRGTOL_MOD
  ...
  LOGICAL, SAVE :: LTRGTOL_UPDATE_DEVICE = .TRUE.
...
CONTAINS
  ...
  SUBROUTINE SET_TRGTOL_UPDATE_DEVICE(LDUPDATE_DEVICE)
    ...
    LTRGTOL_UPDATE_DEVICE = LDUPDATE_DEVICE
...
#define TRGTOL_DTYPE MPI_REAL8
    ...
    LUPDATE_DEVICE = LTRGTOL_UPDATE_DEVICE
