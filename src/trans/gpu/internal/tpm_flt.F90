...
#ifndef TRANS_SINGLE
USE BUTTERFLY_ALG_DP_MOD, ONLY: HYBRID_MATRIX, BUTTERFLY_GPU_PLAN
#endif
...
#ifndef TRANS_SINGLE
TYPE(HYBRID_MATRIX) :: YHYBRID_S,YHYBRID_A
TYPE(HYBRID_MATRIX) :: YHYBRID_DIRECT_S,YHYBRID_DIRECT_A
#endif
END TYPE FLT_TYPE
...
#ifndef TRANS_SINGLE
TYPE(BUTTERFLY_GPU_PLAN) :: PLAN_S,PLAN_A
TYPE(BUTTERFLY_GPU_PLAN) :: PLAN_DIRECT_S,PLAN_DIRECT_A
#endif
